(function(e, t) {
	...
	function Mt(e) {
		return typeof e.getElementsByTagName != 'undefined'
			...
			: typeof e.querySelectorAll != 'undefined' ? e.querySelectorAll('*') : [];
	}
	function _t(e) {
	...
	function nn(e) {
		...
		if (n === 'none' || n === '') {
			Pt = i.body.appendChild(
				Pt ||
					v.extend(i.createElement('iframe'), { frameBorder: 0, width: 0, height: 0 })
			);
	...
	function Kn(e, t, n) {
		var r,
			...
			a = function() {
				...
				return (
					u.notifyWith(e, [ f, i, n ]), i < 1 && o ? n : (u.resolveWith(e, [ f ]), !1)
				);
			},
			f = u.promise({
				elem: e,
	...
	(v.fn = v.prototype = {
		...
		v.each('Boolean Number String Function Array Date RegExp Object'.split(' '), function(
			e,
			t
		) {
	...
	v.extend({
		...
		removeData: function(e, t, n) {
			...
			o
				? v.cleanData([ e ], !0)
				: v.support.deleteExpando || u != u.window ? delete u[a] : (u[a] = null);
		},
		...
		v.extend({
			...
			dequeue: function(e, t) {
				...
				i === 'inprogress' && ((i = n.shift()), r--),
					i &&
						(t === 'fx' && n.unshift('inprogress'), delete s.stop, i.call(e, o, s)),
					!r && s && s.empty.fire();
			},
			...
			for (r = 0; r < w.length && !n.isPropagationStopped(); r++) {
				...
				for (i = 0; i < a.matches.length && !n.isImmediatePropagationStopped(); i++) {
					...
					if (
						...
						(n.data = c.data),
							(n.handleObj = c),
							(o = ((v.event.special[c.origType] || {}).handle || c.handler)
								.apply(a.elem, g)),
							o !== t &&
								((n.result = o),
							...
							(vt = function(e, r, s, o, u) {
								if (!o && !u && !i.test(e)) {
									...
									if (p)
										try {
											return (
												S.apply(s, x.call(h.querySelectorAll(p), 0)), s
											);
										} catch (v) {
										} finally {
		...
		v.each(
			...
			function(e, t) {
				v.fn[e] = function(n) {
					...
					if (
						(a == null || (a && a.nodeType === 11 && a.childNodes.length === 1)) &&
						u === 1
					)
		...
		(v.speed = function(e, t, n) {
			...
			r.duration = v.fx.off
				...
				: typeof r.duration == 'number'
					? r.duration
					: r.duration in v.fx.speeds ? v.fx.speeds[r.duration] : v.fx.speeds._default;
